...
public class T_E_S_T_DBUnit
{
    ...
    public T_E_S_T_DBUnit()
    {
        ...
        datasource.setURL("jdbc:mysql://localhost:3306/testdb_test");
        datasource.setUser("root");
        datasource.setPassword("admin");
        datasource.setDatabaseName("testdb_test");
    ...
    public void setUp() throws Exception
    {
        try
        {
            ...
            dbConnection = new DatabaseConnection(connection, "testdb_test");
